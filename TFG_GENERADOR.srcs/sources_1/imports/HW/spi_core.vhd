...
architecture arch of spi_core is
...
-- instancia SPI_controller 
   spi_unit : entity xil_defaultlib.spi_controller
      port map(
         clk           => clk,
         reset         => reset,
